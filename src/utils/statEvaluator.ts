...
export function statEvaluator(stat: Stat, baseStat: number, iv: number, ev: number, level: number, nature: string): number {
	if (stat === "hp") {
...
const natureChanges: { [key: string]: { plus: StatChange, minus: StatChange } } = {
